package com.info5059.casestudy.pdfgenerator;
...
public abstract class Generator extends AbstractPdfView {
    public static ByteArrayInputStream generatePo() {
        URL imageUrl = Generator.class.getResource("/static/assets/SomeLogo.png");
